...
import cn.bestwu.gdf.DependencyUtil.toMap
...
class MapNotationToStringNotationHandler : CodeInsightActionHandler {
    ...
    override fun invoke(project: Project, editor: Editor, file: PsiFile) {
        object : WriteCommandAction.Simple<Any>(project, file) {
            ...
            fun toStringNotation(methodCall: GrMethodCall): String {
                ...
                val coordinate = Coordinate.fromMap(toMap(methodCall.namedArguments))
