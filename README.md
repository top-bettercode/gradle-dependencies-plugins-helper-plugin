...
* Support `Use Maven Index for search` and `Use Nexus for search`(Nexus2) options to speed up the dependencies search.
...
* `Use Maven Index for search` and `Use Nexus for search`(Nexus2) is optional.When you can't visit https://api.bintray.com/search/packages/maven or access very slowly,you can use these options to speed up the dependencies search.
